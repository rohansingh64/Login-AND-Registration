...
ofstream outfile("C:/Users/rohan/OneDrive/Documents/programming/my project/cpp project 2/log in.txt", ios::app);
if(!outfile){
...
ifstream infile("C:/Users/rohan/OneDrive/Documents/programming/my project/cpp project 2/log in.txt");
if(!infile){
cout<<"\tError: File Can't Open!"<<endl;
}
else{
